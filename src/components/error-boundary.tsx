...
export const useErrorHandler = () => {
  ...
  const handleError = React.useCallback((error: Error) => {
    console.error('🚨 useErrorHandler - Error manejado:', error);
    // No establecer el error en el estado para evitar ciclos infinitos
    // setError(error);
  }, []);

  // Remover useEffect que causa ciclos infinitos
  // React.useEffect(() => {
  //   if (error) {
  //     throw error;
  //   }
