...
import { Wrench, PlusCircle, Trash2, Smartphone, Gamepad2, Loader2, Sparkles, ThumbsUp, ThumbsDown, CheckCircle, Brain, Terminal, ClipboardCopy } from "lucide-react";
...
export default function EquipmentPage() {
    ...
    return (
        <div className="space-y-8">
            <div>
                <h1 className="text-3xl font-bold">Equipamiento y Configuración</h1>
