...
const deviceList = {
    Telefono: {
        Apple: [
            ...
            { value: "Apple iPhone 13 Pro Max", label: "iPhone 13 Pro Max", screenSize: 6.7 },
            { value: "Apple iPhone 13 Pro", label: "iPhone 13 Pro", screenSize: 6.1 },
            { value: "Apple iPhone 13", label: "iPhone 13", screenSize: 6.1 },
            { value: "Apple iPhone 12 Pro Max", label: "iPhone 12 Pro Max", screenSize: 6.7 },
            { value: "Apple iPhone 12 Pro", label: "iPhone 12 Pro", screenSize: 6.1 },
            { value: "Apple iPhone SE (2022)", label: "iPhone SE (2022)", screenSize: 4.7 },
        ],
        Samsung: [
            ...
            { value: "Samsung Galaxy S23", label: "Galaxy S23", screenSize: 6.1 },
            { value: "Samsung Galaxy S22 Ultra", label: "Galaxy S22 Ultra", screenSize: 6.8 },
            { value: "Samsung Galaxy S22", label: "Galaxy S22", screenSize: 6.1 },
            { value: "Samsung Galaxy S21 FE", label: "Galaxy S21 FE", screenSize: 6.4 },
            ...
            { value: "Samsung Galaxy A54", label: "Galaxy A54", screenSize: 6.4 },
        ],
        Google: [
            ...
            { value: "Google Pixel 7 Pro", label: "Pixel 7 Pro", screenSize: 6.7 },
            { value: "Google Pixel 7a", label: "Pixel 7a", screenSize: 6.1 },
            { value: "Google Pixel 6 Pro", label: "Pixel 6 Pro", screenSize: 6.7 },
        ],
        Asus: [
            { value: "Asus ROG Phone 8 Pro", label: "ROG Phone 8 Pro", screenSize: 6.78 },
            { value: "Asus ROG Phone 8", label: "ROG Phone 8", screenSize: 6.78 },
            { value: "Asus ROG Phone 7", label: "ROG Phone 7", screenSize: 6.78 },
        ],
        Xiaomi: [
            { value: "Xiaomi 14 Ultra", label: "14 Ultra", screenSize: 6.73 },
            { value: "Xiaomi 14 Pro", label: "14 Pro", screenSize: 6.73 },
            { value: "Xiaomi 13 Pro", label: "13 Pro", screenSize: 6.73 },
            { value: "Xiaomi Poco F5 Pro", label: "Poco F5 Pro", screenSize: 6.67 },
            { value: "Xiaomi Redmi Note 13 Pro", label: "Redmi Note 13 Pro", screenSize: 6.67 },
            { value: "Xiaomi Redmi Note 12 Pro", label: "Redmi Note 12 Pro", screenSize: 6.67 },
        ],
        OnePlus: [
            { value: "OnePlus 12", label: "12", screenSize: 6.82 },
            { value: "OnePlus 12R", label: "12R", screenSize: 6.78 },
            { value: "OnePlus 11", label: "11", screenSize: 6.7 },
            { value: "OnePlus Nord 3", label: "Nord 3", screenSize: 6.74 },
    ...
    Tablet: {
        Apple: [
            { value: "Apple iPad Pro 12.9 (M2)", label: "iPad Pro 12.9\" (M2)", screenSize: 12.9 },
            { value: "Apple iPad Pro 11 (M2)", label: "iPad Pro 11\" (M2)", screenSize: 11 },
            { value: "Apple iPad Air (M1)", label: "iPad Air (M1)", screenSize: 10.9 },
            { value: "Apple iPad (10th Gen)", label: "iPad (10th Gen)", screenSize: 10.9 },
            { value: "Apple iPad (9th Gen)", label: "iPad (9th Gen)", screenSize: 10.2 },
            { value: "Apple iPad Mini (6th Gen)", label: "iPad Mini (6th Gen)", screenSize: 8.3 },
        ],
        Samsung: [
            ...
            { value: "Samsung Galaxy Tab S8+", label: "Galaxy Tab S8+", screenSize: 12.4 },
            { value: "Samsung Galaxy Tab S8", label: "Galaxy Tab S8", screenSize: 11 },
            { value: "Samsung Galaxy Tab S7 FE", label: "Galaxy Tab S7 FE", screenSize: 12.4 },
        ],
        Xiaomi: [
            { value: "Xiaomi Pad 6S Pro", label: "Pad 6S Pro", screenSize: 12.4 },
            { value: "Xiaomi Pad 6", label: "Pad 6", screenSize: 11 },
            { value: "Xiaomi Pad 5", label: "Pad 5", screenSize: 11 },
        ],
