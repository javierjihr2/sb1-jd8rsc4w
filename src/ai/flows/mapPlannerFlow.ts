...
7.  **rotationPlan**: Describe un plan de rotación completo y muy detallado.
    *   **route**: Describe la ruta general desde la zona de aterrizaje, considerando el posible cierre de zona.
